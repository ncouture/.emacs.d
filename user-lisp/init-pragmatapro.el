...
;; (defun pragmatapro-update-mode-line-icon ()
;;   "Update the mode line with the appropriate icon for the current mode."
;;   (let ((icon (pragmatapro-get-mode-icon)))
;;     (setq mode-line-front-space
;;           (list " " icon ""))))

;; ;; Add hook to update mode line when entering a new major mode
;; (add-hook 'after-change-major-mode-hook 'pragmatapro-update-mode-line-icon)
